...
prob_priori<-c(p,p2)
test_mult_doses<-function_estim_doses_comp(n=20,probabilite_a_priori = prob_priori,t_star=6,type1 = "decreasing",type2="decreasing",graine=145)
...
test_evol_biais<-evol_biais_comp(K=100,probabilite_a_priori=prob_priori,t_star=6,type1="constant",graine_depart=133,type2="constant")
