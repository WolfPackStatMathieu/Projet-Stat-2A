...
#test_beta_newton_multiple<-modele_survie_Newton_multiple(observations_time = observations_time,id_dose=id_dose,
                                                         ...
                                                         #fenetre)
```
Nous avons obtenu des résultats très différents avec des probabilités proches de 1, en raison de la valeur de beta. Ces methodes ne sont donc pas convenables. 
```{r}
...
plot(x=c(1:5),y=y_proba2,main="Essai avec l'algorithme de Newton.",xlab="Index de la dose",ylab="Probabilit� de la dose")
```
Nous pouvons utiliser d'autres m�thodes ne mobilisant pas la logique bay�sienne. Les m�thodes glm permettent notamment d'expliquer la probabilit� que Y vaut 1 c'est-�-dire que l'individu manifeste la toxicit�. 
```{r}
