...
t<-6
#Les doses administrées � chaque patient sont données par la colonne dose. 
...
#N'étant pas certains de sa signification � l'heure actuelle, nous donnons un poids uniforme. 
identifiant<-donnees$id

#La date d'arrivee du patient dans l'étude est donnée par la colonne time_arrival.
...
tstar<-6
############## Si on utilise l'inf�rence bay�sienne de l'article. ######
