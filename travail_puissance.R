...
######On remarque que la valeur de beta selon l'algorithme de Newton peut beaucoup varier. Par ailleurs, la log -vraisemblance a �t� choisie 
...
##### Autre m�thode, utiliser plusieurs points initiaux. . ####
test_beta_newton_multiple<-modele_survie_Newton_multiple(observations_time = observations_time,id_dose=id_dose,
                                                         ...
                                                         fenetre)
### Si on utilise cette m�thode, on obtient des r�sultats tr�s diff�rents du mod�le puissance. 
### Ces m�thodes ne sont donc pas convenables. 
